...
class DeliveryController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * action new
     * 
     * @param \Glacryl\Glshop\Domain\Model\Delivery $newDelivery
     * @ignorevalidation $newDelivery
     * @return void
     */
    public function newAction(\Glacryl\Glshop\Domain\Model\Delivery $newDelivery = NULL)
    {
        $this->view->assign('newDelivery', $newDelivery);
    }
     ...
     * @return void
     */
    public function createAction(\Glacryl\Glshop\Domain\Model\Delivery $newDelivery)
    {
     ...
     * @ignorevalidation $delivery
     * @return void
     */
    public function editAction(\Glacryl\Glshop\Domain\Model\Delivery $delivery)
    {
     ...
     * @return void
     */
    public function updateAction(\Glacryl\Glshop\Domain\Model\Delivery $delivery)
    {
     ...
     * @return void
     */
    public function deleteAction(\Glacryl\Glshop\Domain\Model\Delivery $delivery)
    {
