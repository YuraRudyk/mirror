...
class InvoiceController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
     ...
     * action new
     * 
     * @param \Glacryl\Glshop\Domain\Model\Invoice $newInvoice
     * @ignorevalidation $newInvoice
     * @return void
     */
    public function newAction(\Glacryl\Glshop\Domain\Model\Invoice $newInvoice = NULL)
    {
     ...
     * @return void
     */
    public function createAction(\Glacryl\Glshop\Domain\Model\Invoice $newInvoice)
    {
     ...
     * @return void
     */
    public function editAction(\Glacryl\Glshop\Domain\Model\Invoice $invoice)
    {
     ...
     * @return void
     */
    public function updateAction(\Glacryl\Glshop\Domain\Model\Invoice $invoice)
    {
     ...
     * @return void
     */
    public function deleteAction(\Glacryl\Glshop\Domain\Model\Invoice $invoice)
    {
