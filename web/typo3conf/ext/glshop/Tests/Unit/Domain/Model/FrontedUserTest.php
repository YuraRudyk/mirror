...
/**
 * Test case for class \Glacryl\Glshop\Domain\Model\FrontedUser.
 *
 ...
 */
class FrontedUserTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Glacryl\Glshop\Domain\Model\FrontedUser
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Glacryl\Glshop\Domain\Model\FrontedUser();
	}
